...
export const AdminSettingsPage: React.FC = () => {
  ...
  const [backupData] = useMutation(BACKUP_SYSTEM_DATA, {
    onCompleted: (data) => {
      const link = document.createElement("a");
      link.href = data.backupSystemData.downloadUrl;
      link.download = data.backupSystemData.filename;
          ...
          <div className="bg-white rounded-lg border border-gray-200">
            ...
            {activeTab === "payments" && (
              <PaymentSettings
                ...
                onSave={(settings) => handleSaveSettings("payments", settings)}
                onChange={handleSettingChange}
                loading={updating}
              />
            )}
